...
export const getAllSolarUnits = async (req, res, next) => {
    try {
...
export const createSolarUnitValidator = (req, res, next) => {
...
export const createSolarUnit = async (req, res, next) => {
    try {
        const data = req.body;
        const newSolarUnit = {
...
export const getSolarUnitById = async (req, res, next) => {
    try {
        const { id } = req.params;
...
export const getSolarUnitForUser = async (req, res, next) => {
    try {
...
export const updateSolarUnitValidator = (req, res, next) => {
...
export const updateSolarUnit = async (req, res, next) => {
    try {
        const { id } = req.params;
...
export const deleteSolarUnit = async (req, res, next) => {
    try {
        const { id } = req.params;
        const solarUnit = await SolarUnit.findById(id);
        if (!solarUnit) {
